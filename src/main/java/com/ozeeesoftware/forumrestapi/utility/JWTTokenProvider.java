package com.ozeeesoftware.forumrestapi.utility;

import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.JWT;
import com.auth0.jwt.exceptions.JWTVerificationException;
import com.ozeeesoftware.forumrestapi.constant.SecurityConstant;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal){
        ...
        return JWT.create().withIssuer(SecurityConstant.OZEEE_SOFTWARE_LLC)
                .withAudience(SecurityConstant.OZEEE_SOFTWARE_ADMINISTRATION)
